...
def test_slide_master_rels_match_repaired_if_present(tmp_path):
    repaired_rels = '/tmp/pptx_wed_check/ex_repaired/ppt/slideMasters/_rels/slideMaster1.xml.rels'
    ...
    with zipfile.ZipFile(str(cp)) as zf:
        ours = zf.read('ppt/slideMasters/_rels/slideMaster1.xml.rels').decode('utf-8')
